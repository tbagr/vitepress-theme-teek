...
```md
![stars](https://img.shields.io/github/stars/tbagr/vitepress-theme-teek)
...
![Star](https://img.shields.io/github/stars/tbagr/vitepress-theme-teek)
...
- name: butcher2000
  desc: 即使再小的帆，也能远航
  avatar: https://gcore.jsdelivr.net/gh/tbagr/static/user/20211029181901.png
...
::: imgCard
```yaml
- img: https://tbagr.com/blog/bg1.webp
...
- img: https://tbagr.com/blog/bg2.webp
  ...
  author: Teek
  avatar: https://testingcf.jsdelivr.net/gh/tbagr/static/user/avatar1.png
- img: https://tbagr.com/blog/bg3.webp
  link: https://tbagr.com
  name: 标题
  desc: 描述内容描述内容描述内容描述内容描述内容描述内容描述内容描述内容描述内容描述内容描述内容描述内容描述内容描述内容描述内容描述内容
```
